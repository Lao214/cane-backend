...
public class CodeGenerator {
    ...
    public void run() {
        ...
        dsc.setUrl("jdbc:mysql://43.136.93.160:3306/cane");
        ...
        pc.setModuleName("integratedHub"); //模块名 //后面会生成 com.example.eduService
        ...
        /**表的名称**/
        strategy.setInclude("b_wuming_base","b_f_base","b_img");
